...
public class EditOfNonTree extends ObjectError {
	...
	public static EditOfNonTree newCase(Set<String> aReferenceSet, Object aTarget, Object aFinder) {
...
//		}
		...
		EditOfNonTree retVal = new EditOfNonTree(aMessage, aReferenceSet, aTarget, aFinder);
		retVal.announce();
		return retVal;
	}
