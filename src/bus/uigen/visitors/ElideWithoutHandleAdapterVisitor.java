...
public class ElideWithoutHandleAdapterVisitor extends AdapterVisitor {	  
  public ElideWithoutHandleAdapterVisitor(ObjectAdapter root) {
    super(root);
  }
