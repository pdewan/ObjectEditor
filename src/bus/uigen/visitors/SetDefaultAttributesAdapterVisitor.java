...
public class SetDefaultAttributesAdapterVisitor extends AdapterVisitor {	  
  public SetDefaultAttributesAdapterVisitor(ObjectAdapter root) {
    super(root);
  }
