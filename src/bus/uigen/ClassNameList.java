...
public class ClassNameList extends AListenableVector {
	ObjectEditor objectEditor;
	String name;
	int childStart;
	Hashtable<String, ClassNameList> nameToClassNameList = new Hashtable();
	Vector<ClassNameList> childrenPackages = new Vector();
	Vector<String> childrenClasses = new Vector();
	//Vector<String> descendents;
	public ClassNameList(Vector initialList, ObjectEditor theObjectEditor, String theName) {
		super();
	...
	public ClassNameList(ObjectEditor theObjectEditor, String theName) {
		super();
		init (theObjectEditor, theName);
		/*
		objectEditor = theObjectEditor;
	...
	*/
	...
	public void addElement(Object childName) {
		...
		if (childClassNameList == null) {
			...
			childClassNameList = new ClassNameList(objectEditor, name +'.' +childPackage );
