...
public class ABasicProblemOperationsModelAttributeRegisterer implements ExecutableCommand {
	public Object execute(Object theFrame) {
		  ObjectEditor.setLabel(ABasicSourceOperationsModel.class, AttributeNames.COMMON_MENU + uiFrame.MENU_NESTING_DELIMITER + uiFrame.SOURCE_MENU);
