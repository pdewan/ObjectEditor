...
public class ANewEditorOperationsModel extends ABasicNewEditorOperationsModel implements FrameModel/*, ForwardBackwardListener*/ {
//	uiFrame frame;
//	@Visible(false)
...
//		uiFrame editor = ObjectEditor.edit(selection.getObject(),  AClassDescriptor.withAttributeRegisterer(), new MenuSetter(), new AMenuDescriptor(), (ObjectAdapter) selection );
