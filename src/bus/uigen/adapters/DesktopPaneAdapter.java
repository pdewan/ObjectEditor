...
public class DesktopPaneAdapter extends PanelAdapter implements
		FocusListener {
	...
	public void linkUIComponentToMe(VirtualComponent c) {
	    ...
	    desktopPane = (VirtualDesktopPane) super.getUIComponent();
	...
	void addToDesktopPane (ObjectAdapter compAdapter ) {
		//JPanel enclosingPanel = new JPanel(); // so no strecthing occurs
		...
		internalFrame.setContentPane(comp);
		internalFrame.pack();
